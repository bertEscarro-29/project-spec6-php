...
if (isset($_POST['selectDepartment']) && isset($_SESSION['school']) && !empty($_POST['departmentID'])) {
    $_SESSION['department'] = $_POST['departmentID'];
}

// Handle program selection
if (isset($_POST['selectProgram']) && isset($_SESSION['department']) && !empty($_POST['programID'])) {
...
<form action="index.php?section=students&page=chooseStudent" method="post">
    <table>
        <tr>
            <td>
                <!-- School dropdown -->
                <select name="schoolID" id="schoolID" class="school-select" <?php echo isset($_SESSION['school']) ? 'disabled' : ''; ?>>
        ...
        <tr>
            <td>
                <!-- Department dropdown -->
                <select name="departmentID" id="departmentID" class="department-select" <?php echo isset($_SESSION['department']) ? 'disabled' : ''; ?>>
