        ...
        <table>
            ...
            <tr>
             ...
             <tr>
                ...
                <td><input readonly type="text" id="departmentCollegeID" name="departmentCollegeID" value="<?= $_GET['deptcollid'] ?? null; ?>" class="data-input"></td>
                <td>
                    <span>
                        <?php echo $_SESSION['errors']['departmentCollegeID'] ?? null; ?>
                    </span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <a href="index.php?section=department&page=departmentList&deptcollid=<?= $_GET['deptcollid'] ?>" class="btn btn-danger">
                        Exit
                    </a>
                </td>
            </tr>
